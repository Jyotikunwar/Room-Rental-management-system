...
export default function LandlordSettings({ user, onLogout, activeRoute, onNavigate, onUserUpdate }: LandlordSettingsProps) {
  ...
  const handleUploadIdDocument = async (file: File) => {
    ...
    try {
      ...
      setIsIdVerified(false);
      setIdMessage({ text: "ID Document uploaded & saved successfully!", ok: true });
    } catch (err) {
      ...
      <div className="flex-1">
        ...
        <div className="flex items-center justify-between border-b border-stone-200 bg-white px-4 py-3 pl-14 sm:px-6 sm:pl-6">
          ...
          <div className="flex items-center gap-4">
            <button onClick={() => onNavigate("messages")} className="text-stone-400 hover:text-stone-600" aria-label="Notifications">
              <Bell size={19} />
            </button>
        ...
        <div className="mx-auto max-w-3xl px-4 py-6 sm:px-6">
          ...
          {!hasIdentification && (
            <div className="mb-6 flex items-start gap-2.5 rounded-2xl border border-amber-200 bg-amber-50 p-4">
              ...
              <p className="text-xs text-amber-800">
                You'll need to add your ID details <span className="font-semibold">and upload a photo of it</span> below before you can complete identity verification.
              </p>
            </div>
          )}
          ...
          <section className="mb-6 rounded-2xl border border-stone-200 bg-white p-5">
            ...
            <p className="mb-4 text-xs text-stone-500">
              A valid government ID is recommended for your profile. Admin uses this to confirm your identity.
            ...
            <div className="mt-4 border-t border-stone-100 pt-4">
              ...
              {idDocumentUrl ? (
                ...
                <p className="mb-2 text-xs text-stone-400">No document uploaded yet — this is required for verification.</p>
              )}
          ...
          <section className="rounded-2xl border border-rose-200 bg-rose-50/40 p-5">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <p className="text-xs text-stone-500">This permanently removes your account and listing history.</p>
              </div>
              {!deleteConfirming ? (
                <button
